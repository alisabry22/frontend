...
let promech12aoe=[];
      ...
      var workbook=  xlsx.readFile("./sql/attend.xlsx");
            ...
            xlsx.writeFile(workbook,"./sql/attend.csv",{bookType:'csv'});
             ...
             command="sqlldr userid=attend/attend control=D:/hr_system/frontend/HRBackend/sql/at_emp_time.ctl log=D:/hr_system/frontend/HRBackend/sql/attendance.log skip=1";
